    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        <div
          ...
          style={{
            backgroundImage:
              'url(https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80)',
          }}
        >
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white animate-fadeInLeft">
          ...
          <div className="space-y-4">
            {['Connect with local food donors', 'Coordinate efficient food distribution', 'Make a real impact in your community'].map(
              (text, i) => (
        ...
        <div className="w-full max-w-md animate-fadeInRight">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {isSignIn ? 'Sign in to continue making a difference' : 'Create an account to start helping your community'}
            </p>
          </div>
